...
const MENU: { id: Game; name: string; about: string; needsVoice?: true }[] = [
	{ id: 'tone', name: '① 성조 챌린지', about: '몇 성인지 몸으로. 전원 동시' },
	{ id: 'blank', name: '② 빈칸 스피드', about: '가린 예문 · 카드 4개 중 동시에' },
	{ id: 'listen', name: '③ 받아쓰기 타임', about: '소리만 두 번 · 한자 4개 중', needsVoice: true },
	{ id: 'explain', name: '④ 스피드 퀴즈', about: '등 지고 앉기 · 한국어로 설명 · 60초' },
	{ id: 'hands', name: '⑤ 선착순 1명', about: '한자만 크게 · 차례로 돌아가며 쉼' },
	{ id: 'relay', name: '⑥ 마이크 타임', about: '마이크 판정 · 자원자만 · 맨 뒤 13분' },
	{ id: 'coop', name: '⑦ 다 같이 클리어', about: '경쟁 없음. 판의 마지막에' },
	{ id: 'hanzi', name: '⑧ 한자 족보', about: '가운데 글자 하나 · 번호를 눌러 열기' },
	{ id: 'cards', name: '단어 훑기', about: '한자 → 병음 → 뜻. 게임 아님' },
...
const RULES: Partial<Record<Game, Rule>> = {
	...
	blank: {
		one: '단어를 가린 예문을 보고, 보기 4개 중에서 고릅니다.',
		steps: [
			'가려진 예문이 한자·병음·한국어 뜻과 함께 뜹니다. 보기는 A~D',
			'시간 제한은 없습니다. 다 같이 생각하고 손가락 1~4로 답합니다',
			'화면에서 보기를 누르면 골라지고, 한 번 더 누르면 확정됩니다',
			'막히면 H 를 눌러 들어갈 말의 뜻을 힌트로 켭니다',
		],
		keys: '보기 두 번 눌러 확정 · Space 다음 · H 힌트 · 1·2 득점 · M 놓침',
	},
	listen: {
	...
	hands: {
		...
		steps: [
			...
			'화면 위에 뜬 사람은 이번 문제를 쉽니다 — 차례로 돌아갑니다',
			'잘했는지와 상관없습니다. 한 사람이 다 가져가지 않게 하려는 것입니다',
		],
 ...
 *
 * ★ ④ 스피드 퀴즈 · ⑥ 마이크 타임 · ⑧ 한자 족보는 판에서 뺐습니다.
 *   초급에게 **보기 없이 스스로 떠올리기**를 요구하는 것들입니다.
 *   목록에서 직접 고를 수는 있습니다.
 *   (④에 `了 把 被` 같은 어법어가 섞이던 것은 `canExplain` 으로 해결했습니다 —
 *    1회차 범위의 15%가 그런 것이었습니다. 그래도 난이도 때문에 판에서는 뺍니다)
 */
				...
				{plan && (
					<Step no={4} title={`${session}회차 판`} why={plan.focus}>
						...
						<p className="opacity-40">
							...
							45분에 안 들어갑니다. 마지막은 늘 <b>⑦ 다 같이 클리어</b> — 진 팀도 같은 편으로
							쉬는 시간에 들어가게요.
						</p>
					</Step>
				)}
